...
- 🚀 **Высокая точность NER**: F1 = 0.91 при 2000 размеченных сообщений
- 🛠️ **Модуль RE** для построения семантических связей: F1 = 0.93
...
- **F1 > 0.5** уже при 400 размеченных сообщений
- **F1 > 0.8** при 700 размеченных сообщений
- **F1 = 0.91** при 2000 сообщениях
